...
* entity[payload][=].what.identifier.value = "urn:uuid:954183f4-bc89-4d75-8073-9b397bacd6ec"
...
* entity[payload][+].role = #source
* entity[payload][=].what.identifier.value = "urn:uuid:cfc9886a-5f54-463b-9255-99bfaf778d8c"
